document.addEventListener('DOMContentLoaded', () => {
    // Pega o termo de busca da URL (ex: ?highlight=molde%20f1)
    ...
    fetch('data.json')
        ...
        .then(data => {
            ...
            unhasData.forEach(professional => {
                ...
                professionalsList.appendChild(block);
        ...
        .catch(error => {
            ...
            professionalsList.innerHTML = '<p>Não foi possível carregar as informações. Tente novamente mais tarde.</p>';
        });
});